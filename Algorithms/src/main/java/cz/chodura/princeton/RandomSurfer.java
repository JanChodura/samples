package cz.chodura.princeton;

import cz.chodura.princeton.util.StdIn;
import cz.chodura.princeton.util.StdOut;
...
public class RandomSurfer {
   ...
   public static void main(String[] args) {
      ...
      if (M != N)
         throw new RuntimeException("M does not equal N");
